...
| Élément | Valeur |
|---|---|
| Version (versionName) | **1.0.62** |
| Code de version (versionCode) | **182** (nombre total de commits — monotone, obligatoirement croissant entre 2 dépôts) |
| Commit de référence | `02b81eb` |
| Statut CI | À publier au prochain push → release `v1.0.62` sur GitHub |
